...
macro(_module_load mod)
    vtk_module_load(${PROJECT_NAME} ${mod})
endmacro()
#-----------------------------------------------------------------------------
...
macro(vtk_module_load ns mod)
  if(NOT ${mod}_LOADED)
    #message ("INCLUDE ${${ns}_MODULE_DIR}/${mod}/${mod}Config.cmake")
    include("${${ns}_MODULE_DIR}/${mod}/${mod}Config.cmake" OPTIONAL RESULT_VARIABLE _found)
    ...
    if(NOT _found)
      ...
      # CMAKE_MODULE_PATH
      include("${${ns}_MODULE_DIR}/${mod}/${mod}Config.cmake" REQUIRED)
    endif()
    if(NOT ${mod}_LOADED)
...
#macro(vtk_module_headers_load ns mod)
#  if(NOT ${mod}_HEADERS_LOADED)
#    include("${${ns}_MODULE_DIR}/${mod}-Headers.cmake"
...
macro(my_module_config ns)
  set(_${ns}_MISSING ${ARGN})
  if(_${ns}_MISSING)
    list(REMOVE_ITEM _${ns}_MISSING ${${ns}_MODULES_ENABLED})
  endif()
  if(_${ns}_MISSING)
    set(msg "")
