...
if(WCL_USE_FILE_INCLUDED)
  return()
endif()
set(WCL_USE_FILE_INCLUDED 1)

# Update CMAKE_MODULE_PATH so includes work.
list(APPEND CMAKE_MODULE_PATH ${WCL_CMAKE_DIR})
